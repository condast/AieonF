...
public class HierarchicalModelAttributeFilter<T extends IDescriptor> extends HierarchicalAttributeFilter<T, IModelLeaf<T>> implements IModelFilter<T, IModelLeaf<T>>
{
