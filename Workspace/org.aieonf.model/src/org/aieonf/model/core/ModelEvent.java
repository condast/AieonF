...
public class ModelEvent<M extends Object> extends EventObject {
	...
	public ModelEvent(Object source, M model ) {
		super( source );
	...
	public ModelEvent(Object source, Collection<M> models ) {
		this( source, models, (models != null ));
	}
	
	public ModelEvent(Object source, Collection<M> models, boolean completed ) {
		super(source);
		this.models = models;
