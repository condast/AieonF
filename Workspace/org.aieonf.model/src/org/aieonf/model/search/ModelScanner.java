...
public class ModelScanner<T extends IDescriptor>{
	...
	public Collection<IModelLeaf<IDescriptor>> search(IModelFilter<T> filter) throws ParseException {
		Collection<IModelLeaf<IDescriptor>> results = new ArrayList<IModelLeaf<IDescriptor>>();
	...
	@SuppressWarnings("unchecked")
	protected void searchModel( Collection<IModelLeaf<IDescriptor>> results, IModelFilter<T> filter, IModelLeaf<T> current ){
