...
import org.aieonf.osgi.flow.AbstractFlowControl;
import org.aieonf.osgi.flow.IFlowControl;
import org.aieonf.osgi.wizard.AbstractFlowControlWizard;
import org.aieonf.osgi.wizard.AbstractFlowWizardPage;
import org.aieonf.osgi.wizard.ButtonEvent;
import org.aieonf.osgi.wizard.HeadlessWizardContainer;
import org.aieonf.osgi.wizard.IButtonSelectionListener;
import org.aieonf.osgi.wizard.IButtonWizardContainer;
import org.aieonf.osgi.wizard.IHeadlessWizardContainer;
import org.aieonf.osgi.wizard.IHeadlessWizardContainer.ContainerTypes;
import org.aieonf.osgi.wizard.WizardContainer;
...
public abstract class AbstractXmlFlowWizard<T extends Object> extends AbstractFlowControlWizard<T> {
	...
	/**
	 * Crete the wizard from the provided XML file
	 * @param in
	 * @return
	 */
	...
	protected IHeadlessWizardContainer onSelectContainer(int index) {
		...
		default:
			...
			for( IButtonWizardContainer.Buttons button: is.getButtons()){
	...
	protected class FlowControl extends AbstractFlowControl<T>{
		...
		protected int onNextIndex(int index) {
			String next = getIndexStore( index ).getButtonPushed( IButtonWizardContainer.Buttons.NEXT );
