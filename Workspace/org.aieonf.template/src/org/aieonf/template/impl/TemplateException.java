...
/**
  ...
  */
   ...
   * @param cause Exception
  */
  public TemplateException( String msg, Exception cause )
  {
    super( msg, cause );
  }
   ...
   * @param msg String
  */
  public TemplateException( String location, String msg )
  {
    super( "[" + location + "]: " + msg );
  }
   ...
   * @param cause Exception
  */
  public TemplateException( String location, String msg, Exception cause )
  {
