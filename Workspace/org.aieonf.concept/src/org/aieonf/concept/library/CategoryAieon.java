...
public class CategoryAieon extends ConceptWrapper implements IImplicitAieon<IDescriptor>
{
  ...
  */
  ...
  {
    this.set(  Attributes.CATEGORY, category );
  }
  ...
  */
  ...
  {
    return ( descriptor.get(  Attributes.CATEGORY ) != null );
  }
  ...
  */
  public static String getCategoryName( IDescriptor descriptor )
  {
    if( isCategory( descriptor ))
      return ( descriptor.get(  Attributes.CATEGORY.toString() ));
    return null;
  }
  ...
  */
	...
	{
		return  Attributes.CATEGORY.toString();
	}
  ...
  */
	...
	public boolean isFamily(Object descriptor)
	{
		if(!( descriptor instanceof IDescriptor ))
			return false;
		return ImplicitAieon.isFamily( this,   Attributes.CATEGORY.toString(), descriptor);
	}
}
